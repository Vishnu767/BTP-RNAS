...
class NAO(nn.Module):
    ...
    def generate_new_arch_with_mras(self, input_variable, predict_lambda=1, direction='-'):
        new_encoder_outputs, new_arch_emb = self.encoder.infer_mras(input_variable, predict_lambda, direction=direction)
